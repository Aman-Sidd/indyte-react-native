...
const MedicineFinalModal = ({navigation}) => {
  return (
    <View style={styles.SleepModalMain}>
      <View style={styles.InnerModal}>
        ...
        <TextMedium style={styles.DescTxt}>
          Useful Tips : Poor sleep is one of the strongest risk factors for
          weight gain, so taking care of your sleep is important{' '}
        </TextMedium>
        <SolidButton
          containerStyle={styles.Btn}
          onPress={() => navigation.navigate(SCREENS.MEDICINESCHEDULER)}>
...
export default MedicineFinalModal;
